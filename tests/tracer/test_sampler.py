...
from ddtrace.constants import UPSTREAM_SERVICES_KEY
...
def test_datadog_sampler_sample_no_rules(mock_sample, dummy_tracer):
    ...
    assert_upstream_services(spans[0], entry="dW5uYW1lZC1weXRob24tc2VydmljZQ|1|1|1.0000")
    ...
    assert_sampling_decision_tags(spans[0], agent=1.0, limit=None, rule=None)
    assert_upstream_services(spans[0], entry="dW5uYW1lZC1weXRob24tc2VydmljZQ|0|1|1.0000")
